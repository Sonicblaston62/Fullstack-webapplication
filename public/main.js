const items = [
    ...
    {developer: "Christian Whitehead, Headcannon, PadagodaWest Games", publisher: "SEGA", name: "Sonic Mania", cover: "images/sonic_mania.jpg", genre: "Action, Adventure, Casual", releaseDate: "Aug 29, 2017", description: "Sonic Mania is an all-new adventure with Sonic, Tails, and Knuckles full of unique bosses, rolling 2D landscapes, and fun classic gameplay." },
